...
func (x *APIStatusDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*APIStatusDetails) ProtoMessage() {}

func (x *APIStatusDetails) ProtoReflect() protoreflect.Message {
	mi := &file_health_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use APIStatusDetails.ProtoReflect.Descriptor instead.
func (*APIStatusDetails) Descriptor() ([]byte, []int) {
	return file_health_proto_rawDescGZIP(), []int{0}
}

func (x *APIStatusDetails) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\x06health\x1a\x1bgoogle/protobuf/empty.proto\",\n" +
	"\x10APIStatusDetails\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion2N\n" +
	"\rHealthService\x12=\n" +
	"\tAPIStatus\x12\x16.google.protobuf.Empty\x1a\x18.health.APIStatusDetailsB\tZ\a/healthb\x06proto3"
...
var file_health_proto_goTypes = []any{
	(*APIStatusDetails)(nil), // 0: health.APIStatusDetails
	(*emptypb.Empty)(nil),    // 1: google.protobuf.Empty
}
var file_health_proto_depIdxs = []int32{
	1, // 0: health.HealthService.APIStatus:input_type -> google.protobuf.Empty
	0, // 1: health.HealthService.APIStatus:output_type -> health.APIStatusDetails
